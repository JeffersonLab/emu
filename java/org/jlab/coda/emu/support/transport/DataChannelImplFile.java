...
logger.info("      DataChannel File out: disc is full, waiting ...");
                    ...
                    if (emu.theEndIsNigh()) {
                        ...
                        if (ri.getEventType().isBuildable()) {
                            ...
                            if (ri.getBuffer() != null) {
                                evioFileWriter.writeEventToFile(null, ri.getBuffer(), forceToDisk);
                            }
                            else {
                                evioFileWriter.writeEventToFile(ri.getNode(), forceToDisk, true);
                            }
...
//System.out.println("      DataChannel File out: sleep 1 sec ..... and try writing again");
                        // Wait 1 sec
                        Thread.sleep(1000);
