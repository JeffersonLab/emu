...
//System.out.println("Emu: cMsgPortal got IP = " + ip + "\n try connecting with udl = " + UDL);
    ...
    private void updateAndSendLoggingMessage(String errorMsg, int errorLevel,
        ...
        try {
            ...
            item = new cMsgPayloadItem("state", emu.state().name());
            errorMessage.addPayloadItem(item);
     ...
     */
    synchronized public void rcGuiInfoMessage(String text) {
        updateAndSendLoggingMessage(text, LoggingEvent.RC_GUI_CONSOLE, "INFO");
    }
