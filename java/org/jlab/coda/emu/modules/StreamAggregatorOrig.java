 ...
 */
public class StreamAggregatorOrig extends ModuleAdapter {
     ...
     */
    public StreamAggregatorOrig(String name, Map<String, String> attributeMap, Emu emu) {
...
//dumpData = true;wq
        ...
        // The only way a StreamAggregatorOrig gets created in the first place
