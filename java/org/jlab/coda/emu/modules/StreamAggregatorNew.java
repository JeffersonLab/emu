 ...
 */
public class StreamAggregatorNew extends ModuleAdapter {
     ...
     */
    public StreamAggregatorNew(String name, Map<String, String> attributeMap, Emu emu) {
...
//System.out.println("  Agg mod: ch" + chan + ", sorter available seq[" + chan + "]  = " + availableSequences[chan]);
                            ...
                            while ((nextSequences[chan] <= availableSequences[chan]) || (storedBank[chan] != null)) {
                                ...
                                if (frameSkips[chan] > 0) {
                                    frameSkips[chan]--;
System.out.println("  Agg mod: sorter, skip frame " + lookingForFrame + " for chan " + chan +
