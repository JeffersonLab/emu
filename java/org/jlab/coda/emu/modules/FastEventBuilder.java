...
//dumpData = true;
        ...
        // since it costs real memory. For Hall D, 17kB/trigger * 40 triggers =
        // 700kB / entangled event x 256 buffers = 179MB.
...
// TODO: Double check to make sure output channels don't do something weird
                ...
                // Initial size of buffers in bytes
                int bufSize = 140000;
                ...
                ByteBufferSupply bbSupply = new ByteBufferSupply(ringItemCount, bufSize, outputOrder,
