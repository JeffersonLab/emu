...
if (nonFatalError) System.out.println("\nERROR 2\n");
                        ...
                        firstEventNumber  = (short)buildingBanks[0].getFirstEventNumber(); // lowest 16 bits only
...
//System.out.println("lastOutputQIndex = " + lastOutputQIndex);
                            }
                            finally {
                                putLock.unlock();
                            }
