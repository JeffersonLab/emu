...
System.out.println("RocSimulation module: quitting watcher thread");
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i < 3000000; i++) {
            try {
                Evio.createRocDataTransportRecord(1, 0, 11, 0, 1, 1, 0, 1, 1, false);
                counter++;
            }
...
System.out.println("INTERRUPTED thread " + Thread.currentThread().getName());
    ...
    */
   private class DataGenerateJob implements Runnable {
       ...
       /** Constructor. */
       DataGenerateJob(long timeStamp, int status, int recordId, int tag, int evNum, int inputOrder) {
           eventBuilder    = new EventBuilder(new EvioEvent(tag, DataType.BANK, recordId));
           this.evNum      = evNum;
           this.status     = status;
