...
public class ApplicationConsole implements KbdHandler, Runnable {
    ...
    private ApplicationConsole(BufferedReader inp, PrintWriter outp) {
        ...
        monitorThread = new Thread(EMUComponentImpl.THREAD_GROUP, this, "Console Monitor");
    }
    ...
    */
    public void run() {
        ...
        do try {
            out.print(EMUComponentImpl.INSTANCE.name() + "> ");
            out.flush();
