...
public class DataTransportRecord {
    /** Field bufferLength */
     ...
     * @param l  of type int
     */
    public DataTransportRecord(byte[] db, int l) {
        data = db;
        bufferLength = l;
        setRecordHeader(0);
    }
     ...
     * @param l of type int
     */
    public DataTransportRecord(int l) {
        data = new byte[l];
        bufferLength = l;
        setRecordHeader(0);
    }
     ...
     * @param l of type int
     */
    public DataTransportRecord(int l, long count, int evcount, int id) {
        data = new byte[l];
        bufferLength = l;
        setRecordHeader(0);
        setSourceID(id);
