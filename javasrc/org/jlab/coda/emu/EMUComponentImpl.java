...
import org.jlab.coda.support.kbd.KbdHandler;
 ...
 */
public class EMUComponentImpl implements KbdHandler, CODAComponent {
    ...
    * (non-Javadoc)
    *
    * @see org.jlab.coda.support.component.CODAComponent#list()
    */
    public void list() {
        if (MODULE_FACTORY.state() != CODAState.UNCONFIGURED) Logger.info("Dump of configuration", Configurer
                .serialize(loadedConfig));
    ...
    * (non-Javadoc)
    *
    * @see org.jlab.coda.support.component.CODAComponent#run()
    */
    public void run() {
        ...
        do {
            ...
            try {
                ...
                if (!Thread.interrupted()) {
                    ...
                    if ((state != null) && (state != oldState)) {
                        ...
                        if (state == CODAState.ERROR) {
                            Vector<Throwable> causes = CODAState.ERROR
                                    .getCauses();
                ...
                Logger.info("EMUComponentImpl.run() thread exits now");
                return;
            }
        } while (!Thread.interrupted());
        Logger.warn("exit via end of loop");
    }
     ...
     * @return boolean
     * @see org.jlab.coda.support.kbd.KbdHandler#keyHandler(String, PrintWriter, Object)
     */
    ...
    * (non-Javadoc)
    *
    * @see org.jlab.coda.support.component.CODAComponent#getName()
    */
    public String name() {
        return name;
    }
    ...
    public synchronized void execute(Command cmd) {
        ...
        if (cmd.equals(RunControl.configure)) {
            String configF = System.getProperty("org.jlab.coda.emu.config");
            if (configF == null) {
...
*/
     ...
     * @see org.jlab.coda.support.component.CODAComponent#setConfig(String)
     */
     ...
     * @see org.jlab.coda.support.component.CODAComponent#setRunNumber(int)
     */
     ...
     * @see org.jlab.coda.support.component.CODAComponent#setRunType(int)
     */
     ...
     * @see org.jlab.coda.support.component.CODAComponent#setCodaid(int)
     */
